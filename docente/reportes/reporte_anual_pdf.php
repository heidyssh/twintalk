...
");
$stmt->bind_param("iiii", $anio, $anio, $horario_id, $anio);
$stmt->execute();
...
<head>
    <meta charset="UTF-8">
    <title>Reporte anual de clase</title>
    <style>
...
<div class="header">
    ...
    <div class="subtitle">
        Reporte anual de gestión — Año <?= $anio ?>
    </div>
</div>
...
<div class="section-title">Resumen de asistencia anual</div>
<table>
    <tr>
...
<div class="section-title">Tareas publicadas en el año</div>
<?php if (empty($tareas)): ?>
    <p>No hay tareas publicadas en este año para esta clase.</p>
<?php else: ?>
<table>
    <thead>
        <tr>
...
$nombreArchivo = "Reporte_Anual_Horario_{$horario_id}_{$anio}.pdf";
