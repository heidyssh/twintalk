...
<table>
    <tr>
        <th>Curso</th>
        <td><?= htmlspecialchars($horario['nombre_curso']) ?></td>
    </tr>
    <tr>
        <th>Día y hora</th>
        <td>
            <?= htmlspecialchars($horario['nombre_dia']) ?>
    ...
    <!-- 🔹 NUEVO: solo aparece si viene de reporte trimestral (o cualquier periodo) -->
    <?php if ($periodo_inicio && $periodo_fin): ?>
    <tr>
        <th>Periodo del reporte</th>
        <td>
    ...
    <tr>
        ...
        <td><?= htmlspecialchars($horario['descripcion']) ?></td>
    </tr>
    <?php endif; ?>
</table>
